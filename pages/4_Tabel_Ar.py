...
# Dataframe untuk tabel unsur atom relatif
    df = pd.DataFrame({
        'Nama Unsur': ['Hidrogen', 'Helium', 'Litium', 'Berilium', 'Boron', 'Karbon', 'Nitrogen', 'Oksigen', 'Fluorin', 'Neon', 'Natrium', 'Magnesium', 'Almunium', 'Silikon', 'Fosfor', 'Belerang', 'Klor', 'Kalium', 'Kalsium', 'Kromium', 'Mangan', 'Besi', 'Nikel', 'Tembaga', 'Seng', 'Brom', 'Perak', 'Iod', 'Barium', 'Emas', 'Raksa', 'Timbal'],
